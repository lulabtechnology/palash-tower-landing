...
export default function LocationSection() {
  return (
    <section
      id="location"
      className="bg-palash-cream py-20 sm:py-24"
    >
      <div className="container-max section-fade space-y-12">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_1fr] lg:items-start">
          <div className="space-y-4">
            ...
            <div className="relative h-72 overflow-hidden rounded-3xl bg-palash-sandLight/60 shadow-soft-lg">
              <iframe
            ...
            <div className="rounded-3xl border border-palash-sand/60 bg-white/95 p-5 shadow-soft-lg">
              <h3 className="font-display text-xl text-palash-ocean mb-2">
          ...
          <div className="space-y-4">
            <h3 className="font-display text-xl text-palash-ocean">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {touristCards.map((card) => (
            <article
              key={card.title}
              className="rounded-3xl border border-palash-sand/60 bg-white/95 p-5 shadow-soft-lg"
            >
              <h4 className="font-display text-lg text-palash-ocean mb-2">
                {card.title}
              </h4>
