...
export default function SkyDeckSection() {
  return (
    <section
      id="sky-deck"
      className="bg-gradient-to-b from-palash.ocean/80 to-palash.forest/90 py-20 sm:py-24"
    >
      <div className="container-max section-fade">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr] lg:items-center">
          <div>
            <h2 className="font-display text-3xl sm:text-4xl text-palash.sand mb-5">
            ...
            <ul className="grid gap-3 text-sm text-slate-100 sm:grid-cols-2">
              <li className="rounded-2xl bg-black/20 px-4 py-3">
                <span className="font-semibold text-palash.sand">
          ...
          <div className="space-y-5">
            <figure className="relative h-52 overflow-hidden rounded-3xl bg-slate-900 shadow-soft-lg">
              <Image
