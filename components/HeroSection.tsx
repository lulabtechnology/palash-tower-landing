    ...
    >
      ...
      <div className="container-max relative z-10 grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-center section-fade">
        <div className="space-y-6">
          <p className="inline-block rounded-full border border-palash.sand/70 bg-palash.forest/70 px-4 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-palash.sand">
            PALASH TOWER · PANAMA
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <a
              href="#contact"
              className="rounded-full bg-palash.sand px-6 py-3 text-sm font-semibold uppercase tracking-wide text-palash.ocean shadow-soft-lg transition hover:bg-palash.sandLight"
            >
              Book a Private Tour
            </a>
            <a
              href="#sky-deck"
              className="rounded-full border border-palash.sand/70 bg-transparent px-6 py-3 text-sm font-semibold uppercase tracking-wide text-palash.sand transition hover:bg-palash.forest"
            >
